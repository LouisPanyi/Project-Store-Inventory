...
// Popup detail transaksi dengan QRIS dan cetak struk
        ...
        <div className="bg-white rounded-lg shadow-lg w-[400px] p-6 space-y-4">
          ...
          {!detail ? (
            ...
            <div className="text-center space-y-3">
              <p className="text-sm">Silakan scan QRIS untuk membayar</p>
              {detail.qris_url ? (
                <Image
                  src={detail.qris_url}
                  alt="QRIS Code"
                  width={192} // 192px (w-48), wajib ada
                  height={192} // 192px (h-48), wajib ada
                  className="mx-auto border rounded-lg"
                />
              ) : (
                <p className="text-red-500 text-sm">QRIS tidak tersedia</p>
              )}
            </div>
          ) : (
            <div
            ...
            >
              ...
              <div>
                ...
                <p>
                  Jln. W.R Soepratman, Barong Tongkok, Kutai Barat, Kalimantan
                  Timur 75777
                </p>
              ...
              <div>
                ...
                <p className="text-xs">
                  Saran & kritik: ratu-rosari-store.vercel.app
                </p>
              </div>
            </div>
          )}
